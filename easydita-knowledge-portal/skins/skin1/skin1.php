...
function skin1_customizer( $wp_customize) {
	...
	$wp_customize->add_control( 
		...
		'secondary_color', 
		array(
			'label'      => __( 'Secondary Accent Color' , 'easydita_knowledge_portal'),
	...
	$wp_customize->add_section(
		'header_bg',
		array(
		  'title' => __('Background Image', 'easydita_knowledge_portal'),
		  'description' => __('Set the background image or color for the search bar header and home page footer.', 'easydita_knowledge_portal'),
		  'priority' => 59,
		)
	);
	$wp_customize->add_setting(
	...
	$wp_customize->add_control( 
		new WP_Customize_Upload_Control( $wp_customize, 'bg_image', 
			array(
				'label'      => __('Background Image', 'easydita_knowledge_portal'),
				'section'    => 'header_bg',
				'settings'   => 'bg_image',
			)
		)
