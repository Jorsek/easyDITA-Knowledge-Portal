...
<div id="comments" class="comments-area">
	...
	$fields = array(
			'author' =>
				'<div class="comment-form-extra comment-form-author"><label for="author">' . __( 'Name', 'easy_wordpress_docs' ) . '</label> ' .
				( $req ? '<span class="required">*</span>' : '' ) .
				'<input id="author" name="author" type="text" value="' . esc_attr($commenter['comment_author']) .
				'" size="30"' . $aria_req . ' /></div>',
			
			'email' =>
				'<div class="comment-form-extra comment-form-email"><label for="email">' . __( 'Email', 'easy_wordpress_docs' ) . '</label> ' .
				( $req ? '<span class="required">*</span>' : '' ) .
