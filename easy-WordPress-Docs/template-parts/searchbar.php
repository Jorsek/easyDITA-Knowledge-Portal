<?php if (is_front_page()) : ?>
	...
	<div class="home-search">
	  <div class="header"><?php echo get_theme_mod( 'search_header', __('How can we help?', 'easy_wordpress_docs') ) ?></div>
	  ...
	  <form method="get" id="searchform" action="<?php echo esc_url( home_url( '/' ) ); ?>" role="search">
		...
		<button type="submit" class="submit" name="submit" id="searchsubmit"><i class="fa fa-search"></i><span><?php _e('Search', 'easy_wordpress_docs'); ?></span></button>
      </form>
	</div>
	...
	<div class="small-search <?php if (is_search()) { echo 'is-search'; } ?>">
	  <form method="get" id="searchform" action="<?php echo esc_url( home_url( '/' ) ); ?>" role="search">
        ...
        <?php if (is_search()) : ?>
			...
			<button type="submit" class="submit" name="submit" id="searchsubmit"><i class="fa fa-search"></i><span class="text"><?php _e('Search', 'easy_wordpress_docs'); ?></span></button>
		<?php else : ?>
			<button type="submit" class="submit" name="submit" id="searchsubmit"><i class="fa fa-search"></i><span class="text"><?php _e('Search', 'easy_wordpress_docs'); ?></span></button>
		<?php endif; ?>
      </form>
